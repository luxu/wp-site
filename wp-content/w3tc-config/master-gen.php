...
<?php exit; ?>{
    ...
    "cdn.s3.key": "AWS_S3_KEY",
    "cdn.s3.secret": "AWS_S3_SECRET",
...
$content = str_replace('AWS_S3_KEY', $aws_s3_key, $content);
$content = str_replace('AWS_S3_SECRET', $aws_s3_secret, $content);
$content = str_replace('AWS_S3_BUCKET', $aws_s3_bucket, $content);

// this config is written on wordpress bootstrap fetching
// aws credentials from env vars
if(!empty($aws_s3_key)){
  file_put_contents(__DIR__ . "/master.php", $content);
}
?>
